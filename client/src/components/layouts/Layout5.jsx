      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8 pt-28">
        ...
        <div className="glassmorphism p-8 rounded-2xl mb-8 card-3d" style={{animation: 'gentleFloat 6s ease-in-out infinite', animationDelay: '2s'}}>
          ...
          <div className="grid grid-cols-6 gap-4 md:gap-6">
            {/* Row 1: left tall rectangle (col-span-4, h-56) */}
            {profile.gallery[0] && (
              <div className="col-span-4 row-span-2 rounded-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform" onClick={() => openModal(profile.gallery[0], 'image')}>
            ...
            {profile.gallery[1] && (
              <div className="col-span-2 rounded-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform" onClick={() => openModal(profile.gallery[1], 'image')}>
                <div className="h-28 bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                  <img src={profile.gallery[1]} alt="Gallery 2" className="w-full h-full object-cover" />
                </div>
              </div>
            )}
            {profile.gallery[2] && (
              <div className="col-span-2 rounded-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform" onClick={() => openModal(profile.gallery[2], 'image')}>
                <div className="h-28 bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                  <img src={profile.gallery[2]} alt="Gallery 3" className="w-full h-full object-cover" />
                </div>
              </div>
            )}

            {/* Row 3: one wide rectangle full width */}
            {profile.gallery[3] && (
            ...
            {/* Row 4: two squares if more images */}
            {profile.gallery.slice(4, 6).map((src, i) => (
              <div key={`extra-${i}`} className="col-span-3 rounded-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform" onClick={() => openModal(src, 'image')}>
